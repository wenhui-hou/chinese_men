...
if __name__ == "__main__":
    ...
    train_instances = prepare_instance_bert('./data/CHIP-CDN/train_mentions_gold_CHIP-CDN',
                                                args.DATA_DIR + 'train_candidates',
                                                args)
    print("train_instances {}".format(len(train_instances)))
    test_instances = prepare_instance_bert_test('./data/CHIP-CDN/test_mentions_gold_CHIP-CDN',
                                                args.DATA_DIR + 'test_candidates',
                                                args.DATA_DIR + 'generate_scores',
                                                args)
    ...
    with open( '../candidate_generation/data/CHIP-CDN/lattices/save_CHIP-CDN.dset', 'rb') as fp:
        data = pickle.load(fp) 
